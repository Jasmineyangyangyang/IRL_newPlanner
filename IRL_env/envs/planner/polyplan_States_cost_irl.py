...
class Polyplanner():
    def __init__(self, env_data, lane_id):
        ...
        self.road = self.env_data.read_from_csv('/Users/jiaxin/codex/IRL_newCostPlanner/IRL_env/envs/data/processed')
    ...
    def calculate_frenet_coordinates(self, x, y, yaw, speed, a=0.0, kappa=0.0):
        """
    ...
    def poly_trajectory(self, ego_x, ego_y, ego_speed, planner_param, target_speed,
        ...
        s0, s0_dot, s0_ddot, l0, l0_dot, l0_ddot  = self.calculate_frenet_coordinates(
            ego_x, ego_y, ego_yaw, ego_speed, ego_a, ego_kappa
        )
...
if __name__ == '__main__':
    env_data = natural_road_load(lane_id=1)
